...
public class Developer{
	@Id 
	@GeneratedValue(strategy=GenerationType.SEQUENCE,generator="our_sequence_generator")
	@SequenceGenerator(name="our_sequence_generator",sequenceName="our_seq",allocationSize=1)
