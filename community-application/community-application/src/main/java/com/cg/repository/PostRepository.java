...
public interface PostRepository extends JpaRepository<Post, Integer>{
	    ...
	    List<Post> findByQueryContainingIgnoreCaseOrTopicContainingIgnoreCase(@Param("keyword")String keyword);
	    ...
	    @Query(value="Select r from Post r where r.postId= :i")
		List<Post> searchByPostId(@Param("i") int postId);
}
